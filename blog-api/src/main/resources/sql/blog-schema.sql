...
CREATE TABLE `sys_log` (
  ...
  `module` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `nickname` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `operation` varchar(25) COLLATE utf8mb4_bin DEFAULT NULL,
  `params` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `time` bigint(20) DEFAULT NULL,
  `userid` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2994 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
